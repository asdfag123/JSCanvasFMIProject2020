...
function displayPrimitive() {
  ...
  context.rect(startPositionX, startPositionY, 150, 100);
  context.moveTo(startPositionX, startPositionY + 100);
  context.lineTo(startPositionX + 150, startPositionY);
  context.moveTo(startPositionX, startPositionY);
  context.lineTo(startPositionX + 150, startPositionY + 100);
